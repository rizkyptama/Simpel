		...
		<div class="container">
			<a href="<?= base_url();?>">
				<table cellspacing="1" cellpadding="5">
					<tr>
						<td><img src="<?= base_url();?>assets/home/images/pemkotdepok.png" height="50px" width="50px" alt="Pemkot Depok"></td>
						<td>APLIKASI SIMPEL <br> DINAS TENAGA KERJA KOTA DEPOK</td>
					</tr>
				</table>
			</a>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav nav ml-auto menusBar">
					...
					<li class="nav-item"><a href="<?= base_url();?>Home/pelatihan" <?php if ($this->uri->segment(1) == 'login') { ?> class="nav-link nav-active" <?php }else{ ?> class="nav-link" <?php } ?>><span>Pelatihan</span></a></li>

					<li class="nav-item"><a href="<?= base_url();?>Home/lpk" <?php if ($this->uri->segment(1) == 'login') { ?> class="nav-link nav-active" <?php }else{ ?> class="nav-link" <?php } ?>><span>Data LPK</span></a></li>
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="<?= base_url(); ?>Home/daftarPelatihan">Peserta Latihan</a>
							<a class="dropdown-item" href="<?= base_url(); ?>Home/daftarLPK">LPK</a>
							<!-- 
					...
					<li class="nav-item"><a href="<?= base_url();?>Home/login" <?php if ($this->uri->segment(1) == 'login') { ?> class="nav-link nav-active" <?php }else{ ?> class="nav-link" <?php } ?>><span>Login</span></a></li>
