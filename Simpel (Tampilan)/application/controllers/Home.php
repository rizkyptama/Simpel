...
class Home extends CI_Controller {
	...
	public function index()
	{
		$slider = array(
            ...
            'lpk'       => $this->model->dataLPK(3),
            'berita'    => $this->model->dataBerita(3),
            'pelatihan' => $this->model->dataPelatihan(2),
	...
	public function daftarPelatihan() {
		...
		$arraydata = array();
		$data = array(
			"page" => $this->load("Pelatihan Kota Depok - Daftar Pelatihan", $path),
			"content" => $this->load->view('home/daftarPelatihan', $arraydata, true),
		);
			// Captcha configuration
    		$config = array(
    			'img_path'      => 'captcha_images/',
	...
	public function daftarLPK() {
		$path = "";
		$arraydata = array();
		$data = array(
			"page" => $this->load("Pelatihan Kota Depok - Daftar LPK", $path),
			"content" => $this->load->view('home/daftarLPK', $arraydata, true),
		);
			// Captcha configuration
    		$config = array(
    			'img_path'      => 'captcha_images/',
	...
	public function login() {
		...
		$data = array(
			...
			"content" => $this->load->view('home/login', $arraydata, true),
		);
			// Captcha configuration
    		$config = array(
    			'img_path'      => 'captcha_images/',
